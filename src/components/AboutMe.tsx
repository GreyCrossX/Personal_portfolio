    ...
    <div className='flex flex-col items-center justify-center p-6 md:p-12 text-text dark:text-text z-40'>
      <div className='max-w-3xl text-center space-y-6'>
        ...
        <p className='text-md md:text-lg'>
          Hi, I'm Miguel A. Athie, also known as GreyX. I specialize in React development, SEO, and copywriting. If you're here, you've likely felt the frustration of building something amazing yet not seeing the results you hoped for.
        </p>
        <p className='text-md md:text-lg'>
        ...
        <div className='bg-black/15 dark:bg-white/15 p-4 rounded-md shadow-lg'>
          ...
          <p className='text-right font-bold text-primary-800 dark:text-primary-200'>- Manuel B. Fernández, VAPA Inc</p>
        </div>
        <p className='text-md md:text-lg'>
          I'm excited to help you achieve your goals. Let's create something amazing together.
        </p>
        <button
          className='mt-6 px-6 py-2 bg-primary-500 text-white font-bold rounded-md hover:bg-primary-800 z-40'
